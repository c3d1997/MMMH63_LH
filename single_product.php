...
-->
                ...
                <div class="column-bottom">
                    <?php for ($i = 0; $i < 10; $i++) : ?>
                    <div class="column">
                        <img class="demo cursor" src="imgs/items<?= $k['sid'] ?>/item<?= $i ?>.jpg" style="width:100%"
                            onclick="currentSlide(<?= $i + 1 ?>)" alt="Nature and sunrise">
...
-->
        ...
        <div class="S-product-info">
            <div class="S-product-info-left">
                ...
                <h3 class="S-location"><i
                        class="fa-solid fa-location-dot"></i><?= $k['item_area'], $k['item_dist'], $k['item_address'] ?>
                </h3>
                ...
                <p class="S-lg-d-none S-d-none"><i
                        class="fa-solid fa-door-open"></i><?= $k['rentaltype'], $k['floor'] ?></p>
            </div>
