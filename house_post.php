...
<div class="container">
    <div class="c-world">
        ...
        <div class="c-mylist">
            <ul>
                <li class="c-list"><a href="personal-data.php">
                        <h3>會員資料</h3>
                    </a></li>
                <li tabindex="1" class="c-list-active"><a href="house_post.php">
                        <h3>刊登物件</h3>
                    </a></li>
            ...
            <div class="c-table">
                <table class="content-table">
                    ...
                    <tbody>
                        <?php foreach ($items as $i) : ?>
                            <tr>
                                <td><a href="single_product.php?sid=<?= $i["item_sid"] ?>">
                                        <p><?= $i["item_name"] ?></p>
                                    </a></td>
                                <td>
                                    <p><?= $i["contract"] ?></p>
                        ...
                        <tr class="active-row">
                            ...
                            <td><a href="myrent_contract02.php">
                                    <p class="check"></p>
                                </a></td>
                            <td>
                                <p></p>
