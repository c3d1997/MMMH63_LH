        ...
        <div class="S-Reservation-area">
            ...
            <div class="S-Reservation-wrap">
                <div class="S-Reservation">
                    ...
                    <div class="S-Reservation-info">
                        ...
                        <h3 class="S-Reservation-location">
                            <i
                                class="fa-solid fa-location-dot"></i><?= $i['item_area'], $i['item_dist'], $i['item_address'] ?>
                        </h3>
                ...
                <div class="S-Reservation-btn">
                    ...
                    <button class="pc-button-F4F4F4-180"><a href="customer_service.php">聯絡我們</a></button>
                    ...
                    <dialog id="infoModal">
                        <div class="ReservationSuccess-wrap">
                            <div class="ReservationSuccess">
                                ...
                                <h2>預約成功</h2>
                                <a href="single_product.php?sid=63"><button
                                        class="pc-button-FEAC00-272 mobile-button-FEAC00-162" id="close">返回</button></a>
                            </div>
