...
<?php include __DIR__ . '/searchpage.php'  ?>
...
<script>
    ...
    // function check()
    // {
    //     var search_form=document.getElementById("search_form").value;

    //     $_xmlHttpRequest();
    //     xmlHTTP.open("GET","search_list.php?search_form="+search_form,ture);
    ...
    //                     document.getElementById("search_all_all").innerHTML=str;
    //                 }
    //             }
    //         }
    //         xmlHTTP.send(null);
