...
<?php include __DIR__ . './part/footer.php'  ?>
    ...
    <script>
        ...
        $(".fast").click(function(){
        // console.log("gg")
        $("#item_info").val("周邊機能完善，離捷運站步行只要30分鐘，非常方便，近捷運商圈，環境單純，房間寬敞舒適，室友友善，和藹可親，絕對是居家旅行，必備租屋。頂級歐式衛浴、板岩壁磚、蓮蓬淋浴組．高雅時尚風寧靜文教區、採光絕佳、生活機能強、人文氣息濃、外籍名流圈緊鄰公園、交通便捷，附近有便利商店、傳統市場、公園綠地、學校、醫療機構、夜市。")
        $("#roommate_info").val("我們是一群熱愛電影和電動的好室友，歡迎跟我們搭伙，我們有PS5、switch、VR、該有的應有盡有，絕對不會無聊。歡迎來當我們的室友!!非常歡迎在台北工作打拼的上班族、學生、和不同文化國家朋友的一個簡單生活的家，希望可以留下一段美好且快樂的回憶。")
    })
