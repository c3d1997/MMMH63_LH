...
<div class="c_container_content">
    <div class="c_content_box">
        <div class="c_scroll-object">
            ...
            第一條：房屋所在地及使用範圍：
            房屋標示： 台北(市)_松山_（鎮、市、區）__街（路）三_段_20_巷_19_弄_23_號_3_樓。
            <br>
            租賃範圍： （一）房屋: 部分：第_1_層 房間_B_，
            面積 35 坪
            <br><br>
            第二條：租賃期限：
            租賃期間自西元 2022 年 6 月 8 日起 至西元 2023 年 7 月 8 日止。
            <br><br>
...
<section>
    <div class="c_confirm_bar">
        <label>
            ...
            <span class="z_all-center">我已仔細閱讀並明瞭<a href="#"> 「服務條款」 </a>，<a href="#"> 「免責聲明」 </a>和<a href="#"> 「隱私權聲明」
                </a>等所載內容及其意義，茲同意該等條款規定，並願遵守網站現今、嗣後規範的各種規則。</span>
        </label>
    </div>
</section>
<!---------------------button------------------------->
...
<div class="c_button_section">
    <div class="c_button_left">
        <a href="contract04.php" style="text-decoration: none; color:#0E2E3D;"><button
                class="pc-button-FEAC00-180">確認</button></a>
